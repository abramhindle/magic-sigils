...
veve_driver:	veve_driver.ml abez.cmx munkres.cmx shape.cmx contour.cmx captchas.cmx shrinker.cmx pca.cmx rotter.cmx kmeans.cmx cmlib.cmx veve.cmx
	ocamlopt.opt -w s -o veve_driver -I ocaml-v4l/ -I +camlimages ${COMPFLAGS_CAMLIMAGES}  ${LINKFLAGS_CAMLIMAGES} unix.cmxa lapjv.cmx abez.cmx munkres.cmx shape.cmx captchas.cmx shrinker.cmx contour.cmx pca.cmx rotter.cmx kmeans.cmx cmlib.cmx sobel.cmx veve.cmx veve_driver.ml
...
veve.cmx: veve.ml captchas.cmx abez.cmx lapjv.cmx munkres.cmx shape.cmx contour.cmx kmeans.cmx
	ocamlopt.opt -c -I ocaml-v4l/ -I +camlimages ${COMPFLAGS_CAMLIMAGES}  ${LINKFLAGS_CAMLIMAGES} lapjv.cmx munkres.cmx shape.cmx abez.cmx contour.cmx kmeans.cmx veve.ml
